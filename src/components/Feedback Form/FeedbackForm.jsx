...
const FeedbackForm = () => {
  ...
  const validateForm = () => {
    ...
    // Commented out validation for removed fields
    // if (!formData.prn.trim()) newErrors.prn = "PRN is required";
    // if (!formData.age) newErrors.age = "Age is required";
    // if (!formData.gender) newErrors.gender = "Gender is required";
    // if (!formData.doctor_name.trim()) newErrors.doctor_name = "Doctor name is required";
  ...
  const preparePayload = () => {
    return {
      ...
      ipd_no: formData.ipd_no.trim(),
      // prn: formData.prn.trim(),
      // Commented out fields from payload
      // age: parseInt(formData.age),
      // gender: formData.gender,
      // doctor_name: formData.doctor_name.trim(),
      // ward_admission_no: formData.ward_admission_no.trim(),
      ...
      >
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {/* Patient Name */}
              <motion.div variants={staggerItem} className="col-span-1 sm:col-span-2 lg:col-span-3">
                <label className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1">
                  Patient Name <span className="text-secondary">*</span>
                </label>
                <input
                  ...
                  value={formData.fullname}
                  onChange={handleInputChange}
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-lg sm:rounded-xl text-sm sm:text-base focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all bg-white/70 backdrop-blur-sm ${errors.fullname ? "border-red-400 bg-red-50" : "border-gray-200"
                    }`}
                  placeholder="Enter patient name"
                />
                {errors.fullname && (
              ...
              <motion.div variants={staggerItem} className="col-span-2">
                ...
                <input
                  ...
                  maxLength={10}
                  inputMode="numeric"
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-lg sm:rounded-xl text-sm sm:text-base focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all bg-white/70 backdrop-blur-sm ${errors.mobilenumber ? "border-red-400 bg-red-50" : "border-gray-200"
                    }`}
                  placeholder="0000000000"
                />
                {errors.mobilenumber && (
              ...
              <motion.div variants={staggerItem} className="col-span-1">
                ...
                <input
                  ...
                  value={formData.ipd_no}
                  onChange={handleInputChange}
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-lg sm:rounded-xl text-sm sm:text-base focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all bg-white/70 backdrop-blur-sm ${errors.ipd_no ? "border-red-400 bg-red-50" : "border-gray-200"
                    }`}
                  placeholder="Enter IPD No."
                />
                {errors.ipd_no && (
              ...
              {/* ============================================== */}
              {/* COMMENTED OUT FIELDS START */}
              {/* ============================================== */}

              {/* Doctor Name - COMMENTED OUT */}
              {/* <motion.div variants={staggerItem}>
                <label className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1">
                  Doctor Name <span className="text-secondary">*</span>
                </label>
              ...
              {/* Ward/Admission No - COMMENTED OUT */}
              {/* <motion.div variants={staggerItem}>
                <label className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1">
                  Ward/Admission No. <span className="text-secondary">*</span>
                </label>
              ...
              >
                ...
                {section.fields.map((field, fIdx) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: fIdx * 0.05 }}
                    className={`group ${errors[field.key] ? "bg-red-50/80 rounded-lg sm:rounded-xl" : ""
                      }`}
                  >
                    {/* Mobile View - Card Style */}
                    <div className="sm:hidden p-3 border-b border-gray-100/50">
                      ...
                      <div className="grid grid-cols-5 gap-1">
                        {RATING_OPTIONS.map((option) => (
                          ...
                          >
                            ...
                            />
                            <div
                              className={`w-8 h-8 rounded-md border-2 flex items-center justify-center transition-all duration-200 ${formData[field.key] === option.value
                                ? "border-primary bg-primary scale-110"
                                : "border-gray-300 bg-white active:scale-95"
                                }`}
                            >
                    ...
                    <div className="hidden sm:grid lg:hidden grid-cols-6 gap-2 items-center py-2 px-2 border-b border-gray-100/50 hover:bg-white/50 transition-all rounded-lg">
                      ...
                      {RATING_OPTIONS.map((option) => (
                        ...
                        >
                          ...
                          />
                          <div
                            className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all duration-200 ${formData[field.key] === option.value
                              ? "border-primary bg-gradient-to-r from-primary to-secondary"
                              : "border-gray-300 bg-white hover:border-secondary"
                              }`}
                          >
                      ...
                      <div className="col-span-8 grid grid-cols-5 gap-2">
                        {RATING_OPTIONS.map((option) => (
                          ...
                          >
                            ...
                            />
                            <div
                              className={`w-7 h-7 rounded-md border-2 flex items-center justify-center transition-all duration-300 shadow-sm ${formData[field.key] === option.value
                                ? "border-primary bg-primary scale-110"
                                : "border-gray-300 bg-white hover:border-secondary hover:scale-105 group-hover/radio:border-secondary"
                                }`}
                            >
          ...
          >
            ...
            <div className="mb-4 sm:mb-6">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={4}
                className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-lg sm:rounded-xl text-sm sm:text-base focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none resize-none transition-all bg-white/70 backdrop-blur-sm ${errors.feedback ? "border-red-400 bg-red-50" : "border-gray-200"
                  }`}
                placeholder="Please share your experience, suggestions, or any special appreciation..."
              />
              {errors.feedback && (
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
              <motion.div variants={staggerItem} className="w-full sm:w-1/2 lg:w-1/3">
                ...
                <input
                  ...
                  value={formData.sign_name}
                  onChange={handleInputChange}
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-lg sm:rounded-xl text-sm sm:text-base focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none italic transition-all bg-white/70 backdrop-blur-sm ${errors.sign_name ? "border-red-400 bg-red-50" : "border-gray-200"
                    }`}
                  placeholder="Type your name as signature"
                />
                {errors.sign_name && (
