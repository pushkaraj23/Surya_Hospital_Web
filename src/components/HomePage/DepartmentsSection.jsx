...
import { useState, useEffect } from "react";
import { fetchDepartments, getFullImageUrl } from "../../api/userApi"; // ✅ Import getFullImageUrl
import { useNavigate } from "react-router-dom";
import { motion, useAnimation } from "framer-motion";
import { useInView } from "react-intersection-observer";
  ...
  useEffect(() => {
    const loadDepartments = async () => {
      try {
        ...
        // ✅ Map through data and ensure bannerimage has full URL
          ...
          return (
            ...
            >
              ...
              {expanded && dept.bannerimage ? (
                <div className="w-full h-full rounded-2xl overflow-hidden flex flex-col">
                  <motion.img
                    src={dept.bannerimage} // ✅ Now contains full URL
                    alt={dept.name}
                    initial={{ scale: 1.1 }}
                    animate={{ scale: 1 }}
                    transition={{ duration: 0.6 }}
