...
import { useState, useEffect } from "react";
import { getExperts, getFullImageUrl } from "../../api/userApi"; // ✅ Import getFullImageUrl
import { motion } from "framer-motion";
import { useNavigate } from "react-router-dom";
    ...
    const loadExperts = async () => {
      try {
        ...
        const formatted = data.map((doc) => ({
          ...
          image: getFullImageUrl(doc.photo),
        }));
  ...
  return (
    ...
    >
      ...
      <div className="bg-white/60 backdrop-blur-xl rounded-2xl p-3 shadow-2xl mb-2 w-[92%]">
        ...
        <p 
          className="text-primary/70 font-medium text-center text-xs mt-2 line-clamp-3" 
