...
import { motion, useInView } from "framer-motion";
import { useRef, useEffect, useState } from "react";
import { fetchHeroSection, getFullImageUrl } from "../../api/userApi"; // ✅ Imported getFullImageUrl
    ...
    <div className="px-5">
      ...
      >
        ...
        {hero?.images && hero.images.length > 0 && (
          <motion.img
            key={currentImageIndex} // Forces animation on change
            // ✅ Applied getFullImageUrl to attach Base URL
            src={getFullImageUrl(hero.images[currentImageIndex])}
            alt="doctor-photo"
            initial={{ opacity: 0, x: 80 }}
            animate={{
              opacity: 1,
