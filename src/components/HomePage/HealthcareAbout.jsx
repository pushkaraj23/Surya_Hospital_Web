...
// import { motion, useInView } from "framer-motion";
// import { useRef, useState, useEffect } from "react";
// import { fetchHomeAbout, getFullImageUrl } from "../../api/userApi"; // ✅ Import getFullImageUrl
...
//                 src={getFullImageUrl(data.image1)}
//                 alt="Hospital 1"
//                 className="w-full h-100 object-cover"
//               />
//             </div>
...
//               <img
//                 // ✅ Use getFullImageUrl to attach Base URL
//                 src={getFullImageUrl(data.image2)}
//                 alt="Hospital 2"
//                 className="w-full h-100 object-cover"
//               />
//             </div>
...
import { motion, useInView } from "framer-motion";
import { useRef, useState, useEffect } from "react";
import { fetchHomeAbout, getFullImageUrl } from "../../api/userApi";
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // ✅ DEBUG: Log the raw data and processed URLs
        console.log("📦 Raw HomeAbout data:", result);
        console.log("🖼️ Image 1 path:", result?.image1);
        console.log("🖼️ Image 1 full URL:", getFullImageUrl(result?.image1));
        console.log("🖼️ Image 2 path:", result?.image2);
        console.log("🖼️ Image 2 full URL:", getFullImageUrl(result?.image2));
          ...
          >
            <div className="rounded-3xl overflow-hidden shadow-lg">
              <img
                ...
                className="w-full h-100 object-cover"
                onError={(e) => {
                  console.error("❌ Image 1 failed to load:", getFullImageUrl(data.image1));
                }}
              />
            </div>
          </motion.div>
          ...
          >
            <div className="rounded-3xl overflow-hidden shadow-lg mt-6 max-sm:mt-0">
              <img
                ...
                className="w-full h-100 object-cover"
                onError={(e) => {
                  console.error("❌ Image 2 failed to load:", getFullImageUrl(data.image2));
                }}
              />
            </div>
          </motion.div>
