...
const departmentsData = {
    ...
    doctors: [
        ...
        { 
            ...
            departmentId: 2, 
            image: "https://images.unsplash.com/photo-1594824947933-d0501ba2fe65?w=150&auto=format&fit=crop&q=60",
        ...
        { 
            ...
            departmentId: 3, 
            image: "https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=150&auto=format&fit=crop&q=60",
        ...
        { 
            ...
            departmentId: 3, 
            image: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=150&auto=format&fit=crop&q=60",
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Explore our specialized medical departments, each equipped with expert doctors 
                            and advanced technology to provide comprehensive healthcare services.
                        </p>
                    </div>
                </div>
            </header>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-6">
                    <p className="text-gray-600">
                        Found <span className="font-semibold text-blue-600">{filteredDepartments.length}</span> departments
                ...
                <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
                    <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
                        <div className="text-2xl font-bold text-blue-600 mb-2">{departmentsData.departments.length}</div>
                        <div className="text-gray-600">Specialized Departments</div>
                    </div>
                    <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
                        <div className="text-2xl font-bold text-green-600 mb-2">{departmentsData.doctors.length}+</div>
        ...
        >
            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                    <div className="text-center">
                        <div className="text-sm font-bold text-blue-600">{department.stats.successRate}</div>
                        <div className="text-xs text-gray-500">Success</div>
                    </div>
                    <div className="text-center">
                        <div className="text-sm font-bold text-green-600">{department.stats.patients}</div>
                        <div className="text-xs text-gray-500">Patients</div>
                    </div>
                    <div className="text-center">
                        <div className="text-sm font-bold text-purple-600">{department.stats.experience}</div>
                    ...
                    <div className="lg:col-span-3">
                        ...
                        {activeTab === "overview" && (
                            <div className="bg-white rounded-2xl shadow-lg p-8">
                                <h2 className="text-3xl font-bold text-gray-900 mb-6">Department Overview</h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="bg-blue-50 rounded-xl p-6">
                                        ...
                                        <p className="text-gray-700">{department.availableDays.join(', ')}</p>
                                        <p className="text-gray-600 text-sm mt-2">{department.timings}</p>
                                    </div>
                                    <div className="bg-green-50 rounded-xl p-6">
                                        <h3 className="text-xl font-bold text-gray-900 mb-3">Quick Stats</h3>
                                        <div className="space-y-2">
                                            <div className="flex justify-between">
                                                <span>Success Rate:</span>
                                                <span className="font-semibold">{department.stats.successRate}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span>Patients Treated:</span>
                                                <span className="font-semibold">{department.stats.patients}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span>Experience:</span>
                                                <span className="font-semibold">{department.stats.experience}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {activeTab === "doctors" && (
                            <div className="bg-white rounded-2xl shadow-lg p-8">
                                <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Specialists</h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {doctors.map((doctor) => (
                                        <div 
                                            key={doctor.id} 
                    ...
                    <div className="md:flex">
                        ...
                        <div className="md:w-1/3 bg-gradient-to-br from-blue-500 to-blue-600 p-8 text-white">
                            <div className="text-center">
                                ...
                                <p className="text-blue-100 font-semibold mb-4">{doctor.specialization}</p>
                        ...
                        <div className="md:w-2/3 p-8">
                            <h3 className="text-2xl font-bold text-gray-800 mb-6">About Dr. {doctor.name.split(' ')[1]}</h3>
                            ...
                            {/* Schedule */}
                            <div className="mb-8">
                                <h4 className="text-lg font-bold text-gray-800 mb-4">Available Schedule</h4>
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                        {doctor.availableDays.map((day, index) => (
                                            <div key={index} className="text-center">
                                                <div className="font-semibold text-gray-800">{day}</div>
                                                <div className="text-sm text-gray-600">{doctor.timings}</div>
                                            </div>
                                        ))}
                                    </div>
                                </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-xl font-bold text-gray-800">
                        Book with {doctor ? `Dr. ${entity.name.split(' ')[1]}` : entity.name}
                    </h3>
                    <button
                        onClick={onClose}
